...
<head>
    ...
    <title>Taller Faber - Document</title>
</head>
<body>
    <!-- Barra de navegación -->
    ...
    <div class="card-body">
      <div class="row mb-4">
        <form action="delete.php" method="post">
          ...
          ¿Seguro que quiere eliminar la relacion de la reparacion con código <strong><?=$_GET['IdReparacion']?> y la actuación con código <?=$_GET['Referencia']?></strong>?
      </div>
