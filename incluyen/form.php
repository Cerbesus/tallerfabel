...
<head>
    ...
    <title>Taller Faber - Editar incluyen</title>
</head>
<body>
    <!-- Barra de navegación -->
  ...
  <div class="card border-0 scroll-mt-3">
    <div class="card-header">
      <h2>Añadir/Mofificar relación</h2>
    </div>
    <div class="card-body">
      <div class="row mb-4">
      ...
      <div class="row mb-4">
        <div class="col-lg-3"><label class="col-form-label" for="IdRecambio">Recambio</label></div>
        <div class="col-lg">
          <select class="form-control" name="IdRecambio">
      ...
      <div class="row mb-4">
        <div class="col-lg-3"><label class="col-form-label" for="IdReparacion">Reparación</label></div>
        <div class="col-lg">
      ...
      <div class="row mb-4">
        <div class="col-lg-3"><label class="col-form-label" for="Unidades">Unidades</label></div>
        <div class="col-lg"><input class="form-control" type="text" name="Unidades" id="Unidades" placeholder="Unidades" value="<?=$incluyen['Unidades']?>">             </div>
      </div>
